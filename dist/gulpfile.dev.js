...
function css() {
  return src("./src/css/main.css").pipe(plugins.cleanCss()).pipe(plugins.purgecss({
    content: ["./src/index.html"],
    safelist: ['showBackToTop']
  })).pipe(dest('./dist/css/')).pipe(plugins.gzip()).pipe(gulp.dest("./dist/css/"));
}
