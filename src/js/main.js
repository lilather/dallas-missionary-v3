(function () {
  ...
  function headerBootstrap() {
    ...
    window.pageYOffset ||
        ...
        ? header.classList.add("fixed-header"): header.classList.remove("fixed-eader");
    });
  }
  ...
  function mobile() {
    ...
    mobileMenuButton.addEventListener("click", function () {
      mobileNav.classList.add("mobileMenuOpen"),
        document.body.classList.add("showOverlay"),
        header.classList.add("transparentBackground");
    }),
      closeMobileMenu.addEventListener("click", function () {
        document.body.classList.remove("showOverlay"),
          mobileNav.classList.remove("mobileMenuOpen"),
          header.classList.remove("transparentBackground");
      });
  }
